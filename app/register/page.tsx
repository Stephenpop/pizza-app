...
export default function RegisterPage() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-400 via-red-500 to-orange-600 flex items-center justify-center p-4">
        <div className="text-center animate-bounce-in">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Welcome to PizzaHub!</h1>
          <p className="text-white/90 mb-8">Your account has been created successfully</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-400 via-red-500 to-orange-600 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8 animate-slide-up">
          ...
          <p className="text-white/90 text-lg font-semibold drop-shadow">Create Your Account</p>
          <p className="text-white/80 text-sm mt-1">Join us and start ordering delicious pizzas</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 animate-scale-in">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-orange-500 group-focus-within:scale-110 transition-transform" />
                <input
                  type="text"
                  value={name}
          ...
          <p className="text-center text-sm text-gray-700 mt-6 font-medium">
            ...
            <Link href="/login" className="text-orange-600 font-bold hover:text-red-600 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
